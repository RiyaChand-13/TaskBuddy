...
## Type: Task Buddy is a React based task management application.
---
...
4. Deployment: Deploy on GitHub Pages or Netlify
---

**Required Tools:**

1. Code Editor: Visual Studio Code for your preferred editor)
2. Browser: Google Chrome (or any modern browser)
3. Node.js & npm: To manage dependencies and run the React application
